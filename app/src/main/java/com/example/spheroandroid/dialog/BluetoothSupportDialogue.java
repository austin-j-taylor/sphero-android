...
// Dialog box for when the device doesn't support bluetooth.
public class BluetoothSupportDialogue extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.missingBluetoothSupport)
    ...
    public void onDismiss(DialogInterface dialogInterface) {
        ...
        activity.onSupportDismissListener();
    }
}
