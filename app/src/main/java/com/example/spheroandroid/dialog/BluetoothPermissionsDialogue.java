...
// Dialog box for when permissions aren't given.
public class BluetoothPermissionsDialogue extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.missingBluetoothPermissions)
    ...
    public void onDismiss(DialogInterface dialogInterface) {
        ...
        activity.onPermissionsDismissListener();
    }
}
